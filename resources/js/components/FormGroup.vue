            ...
            <div :class="titleStyle" v-if="group.title">
                <div class="h-8 leading-normal h-full flex items-center box-content"
                    ...
                    <button
                        ...
                        v-if="collapsed">
                        <Icon name="plus" type="micro" class="align-top" width="16" height="16" />
                    </button>
                    <button
                        dusk="collapse-group"
                        type="button"
                        ...
                        v-else>
                        <Icon name="minus" type="micro" class="align-top" width="16" height="16" />
                    </button>
                    ...
                    <div class="flex" v-if="!readonly">
                        <button
                            ...
                            :title="__('Drag')"
                            >
                            <Icon name="chevron-up-down" type="micro" class="align-top" width="16" height="16" />
                        </button>
                        <button
                            dusk="move-up-group"
                            type="button"
                            ...
                            <Icon name="arrow-up" type="micro" class="align-top" width="16" height="16" />
                        </button>
                        <button
                            ...
                            <Icon name="arrow-down" type="micro" class="align-top" width="16" height="16" />
                        </button>
                        <button
                            dusk="delete-group"
                            type="button"
                            ...
                            <Icon name="trash" type="micro" width="16" height="16" />
                        </button>
...
<script>
import { BehavesAsPanel, mapProps } from 'laravel-nova';
